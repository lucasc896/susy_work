{
TString histFileName = "AK5Calo_mSUGRA_m0_220to3000_m12_100to1000_tanb_10andA0_0_7TeV_chris_truth_all.root";
...
_file0->GetObject("preselection_cuts/mSUGRA_Scan_Plane;1", full_scan_ps);
...
TH2D *scan_bmulti_frac_0gev_bf[4], *bmulti_scan_total_0gev_bf, *bmulti_scan_0gev_bf[4];
...
TH2D  *scan_bmulti_frac_0gev_ps[4], *bmulti_scan_total_0gev_ps, *bmulti_scan_0gev_ps[4];

TH2D *scan_bmulti_frac_0gev_ps[0] = new TH2D("ps_frac_0gev_0bs", "ps_frac_0gev_0bs", 150, 0, 3000, 51, 0, 1020);
TH2D *scan_bmulti_frac_0gev_ps[1] = new TH2D("ps_frac_0gev_1bs", "ps_frac_0gev_1bs", 150, 0, 3000, 51, 0, 1020);
TH2D *scan_bmulti_frac_0gev_ps[2] = new TH2D("ps_frac_0gev_2bs", "ps_frac_0gev_2bs", 150, 0, 3000, 51, 0, 1020);
TH2D *scan_bmulti_frac_0gev_ps[3] = new TH2D("ps_frac_0gev_>2bs", "ps_frac_0gev_>2bs", 150, 0, 3000, 51, 0, 1020);

TH2D *bmulti_scan_total_0gev_ps = new TH2D("total_b_0gev_ps", "total_b_0gev_ps", 150, 0, 3000, 51, 0, 1020);

TH2D *bmulti_scan_total_frac_0gev_ps = new TH2D("total_b_frac_0gev_ps", "total_b_frac_0gev_ps", 150, 0, 3000, 51, 0, 1020);


_file0->GetObject("preselection_cuts/mSUGRA_b-quark_multi-0_gev_pt_cut_0;1", bmulti_scan_0gev_ps[0]);
_file0->GetObject("preselection_cuts/mSUGRA_b-quark_multi-0_gev_pt_cut_1;1", bmulti_scan_0gev_ps[1]);
_file0->GetObject("preselection_cuts/mSUGRA_b-quark_multi-0_gev_pt_cut_2;1", bmulti_scan_0gev_ps[2]);
_file0->GetObject("preselection_cuts/mSUGRA_b-quark_multi-0_gev_pt_cut_3;1", bmulti_scan_0gev_ps[3]);


cout << "Filling fractions for PreSelection cuts" << endl;

for(Int_t i=0; i<=3; i++){
	scan_bmulti_frac_0gev_ps[i]->Divide(bmulti_scan_0gev_ps[i], full_scan_ps);
}

// sum 1,2 and >2 plots for 'any' b-quark event
bmulti_scan_total_0gev_ps->Add(bmulti_scan_0gev_ps[1],bmulti_scan_0gev_ps[2]);
bmulti_scan_total_0gev_ps->Add(bmulti_scan_0gev_ps[3]);

bmulti_scan_total_frac_0gev_ps->Divide(bmulti_scan_total_0gev_ps, full_scan_ps);
