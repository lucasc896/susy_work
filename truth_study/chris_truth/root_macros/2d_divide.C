...
TH2D *scan_bmulti_frac_before[0] = new TH2D("0bs", "0bs", 139, 220, 3000, 45, 100, 1000);
TH2D *scan_bmulti_frac_before[1] = new TH2D("1bs", "1bs", 139, 220, 3000, 45, 100, 1000);
TH2D *scan_bmulti_frac_before[2] = new TH2D("2bs", "2bs", 139, 220, 3000, 45, 100, 1000);
TH2D *scan_bmulti_frac_before[3] = new TH2D(">2bs", ">2bs", 139, 220, 3000, 45, 100, 1000);
...
TH2D *scan_bmulti_frac_after[0] = new TH2D("0bs", "0bs", 139, 220, 3000, 45, 100, 1000);
TH2D *scan_bmulti_frac_after[1] = new TH2D("1bs", "1bs", 139, 220, 3000, 45, 100, 1000);
TH2D *scan_bmulti_frac_after[2] = new TH2D("2bs", "2bs", 139, 220, 3000, 45, 100, 1000);
TH2D *scan_bmulti_frac_after[3] = new TH2D(">2bs", ">2bs", 139, 220, 3000, 45, 100, 1000);

_file1->GetObject("after_cuts_b-multiplicity/mSUGRA_Scan_Plane;1", full_scan);
_file1->GetObject("after_cuts_b-multiplicity/mSUGRA_Scan_Plane_b-quark_Multiplicity_0;1", b_multi_scan[0]);
_file1->GetObject("after_cuts_b-multiplicity/mSUGRA_Scan_Plane_b-quark_Multiplicity_1;1", b_multi_scan[1]);
...
for(Int_t i=0; i<=3; i++){
	scan_bmulti_frac_after[i]->Divide(b_multi_scan[i], full_scan);
}
_file1->Write();
_file1->Close();
