...
default_common.Jets.PtCut              = 50.#50.*(275./375.)

cutTreeMC, junkVar,junkVar2            = MakeMCTree(100., Muon=None)#100.*(275./375.),Muon = None)
...
anal_ak5_caloMC.Run(outDir,conf_ak5_caloMC,mc_QCD)
