...
def MakeDataTree(Threshold,Muon = None,Split = None):
  ...
  if Muon == None:
      ...
      else: cutTreeData.TAttach(MHT_METCut,minDRMuonJetCut)
...
Summer11_MC_HighHTBins = WJet_Sample_HighHTBins + TTbar_Sample + SingleT_Sample + Zinv_Sample

Summer11_MC_LowHTBins = WJet_Sample_LowHTBins + TTbar_Sample + SingleT_Sample + Zinv_Sample
